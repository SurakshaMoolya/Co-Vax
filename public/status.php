...
<!----NAVBAR---------->
    ...
    <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
          ...
          <div class="collapse navbar-collapse" id="navbarNav">
            ...
            <a href="logout.php" class="btn btn-primary ms-lg-3">Home</a>
 ...
 <div class="vero vh-10 text-center py-3">
    <div class="container">
        ...
        <form name="fromusr" action="" method="post">
            ...
            <h2>Share vaccination status in your social circle</h2>
            <p>Kindly enter your Email Id and full name as mentioned in CoWIN vaccination certificate</p><br>
              <?php 
                if (!empty($success==1)){
            ...
            <p><input class="form-control" type="text" placeholder="Enter Full Name" name="name" required></p>
            <p><input class="form-control" type="email" placeholder="Enter your Email-Id" name="email" required></p>
